...
#elif defined NINTENDO_WII
	// The same separator CFileMgr already builds its own paths with on this
	// platform, and the one the device prefix in front of it needs: the path
