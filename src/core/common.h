...
#define BSWAP_I32(x) ((int32)__builtin_bswap32((uint32)(x)))
#define BSWAP_U16(x) __builtin_bswap16(x)
#define BSWAP_I16(x) ((int16)__builtin_bswap16((uint16)(x)))

inline float
BSWAP_F32_IMPL(float value)
{
	uint32 bits;
...
#define BSWAP_F32(x) BSWAP_F32_IMPL(x)

inline void
memLittle32(void *value)
{
	uint32 bits;
	memcpy(&bits, value, sizeof(bits));
	bits = BSWAP_U32(bits);
...
#define memLittle32(value) ((void)0)
#define memLittle16(value) ((void)0)
#endif
